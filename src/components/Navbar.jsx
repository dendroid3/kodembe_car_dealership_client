      ...
      <div className="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center h-16 justify-between">
          ...
          <div className="hidden md:flex flex-grow justify-center items-center space-x-20 md:space-x-6">
            <Link to="/" className="hover:text-gray-400">Featured Inventory</Link>
            <Link to="/client/product-listings" className="hover:text-gray-400">Inventory</Link>
            <Link to="/" className="hover:text-gray-400">New Arrivals</Link>
            <Link to="/" className="hover:text-gray-400">Financing</Link>
          </div>}
          ...
          {localStorage.getItem('userId')&&value.userData.role==="Admin" && <div className="hidden sm:flex flex-grow justify-center items-center space-x-20">
            ...
            <Link to="/admin/products" className="hover:text-gray-400">Inventory</Link>
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden mt-2 text-center">
            <Link to="/" className="block py-2 hover:text-gray-400">Featured Inventory</Link>
            <Link to="/client/product-listings" className="block py-2 hover:text-gray-400">Inventory</Link>
            <Link to="/" className="block py-2 hover:text-gray-400">New Arrivals</Link>
            <Link to="/" className="block py-2 hover:text-gray-400">Financing</Link>
          </div>
        )}
      </div>
    </nav>
